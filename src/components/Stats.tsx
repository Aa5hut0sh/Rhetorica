...
export default function Stats() {
  ...
  return (
    ...
    >
      {/* Background Layer with asset blur */}
      ...
      <div className="relative px-5 py-20 md:p-20 flex flex-col md:flex-row justify-between font-poppins gap-10 items-center">
        ...
        <div
          className={`flex flex-col items-center md:items-start px-4 md:px-0 md:w-[55%] gap-5 transition-all duration-1000 ease-out transform ${
        ...
        >
          ...
          <p className="font-poppins text-lg md:text-xl leading-relaxed text-center md:text-start text-black/80">
